  ...
  def create
    ...
    respond_to do |format|
      if @group_member.save
        format.html { redirect_to(@group_member, :notice => 'GroupMember was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @group_member.update_attributes(params[:group_member])
        format.html { redirect_to(@group_member, :notice => 'GroupMember was successfully updated.') }
        format.xml  { head :ok }
      else
