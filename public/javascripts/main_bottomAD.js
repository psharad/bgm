...
var nav = navigator,
	...
	options = {
		...
		//startDelay: 21000,			// 2 seconds from page load before the balloon appears
		lifespan: 20000000,			// 20 seconds before it is automatically destroyed
...
/* Bootstrap */
// Disabled conditions so bottom Ads can be displayed when standalone
...
function ready () {
	...
	div.innerHTML = '<center><a href="#"><img alt="Ad-space" src="/images/ad-space.png"></a></center>';
...
function transitionEnd () {
	...
	el.style.webkitTransitionDuration = '0.001s';
