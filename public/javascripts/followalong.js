...
var followAlong = function (el, options) {
	...
	if (document.addEventListener('blur', that, true)){
		document.addEvenListener('blur', that, false);
	}else if (document.addEventListener('scroll', that, false)){
	  document.addEventListener('scroll', that, false);
	}
